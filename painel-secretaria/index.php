                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        <li class="nav-section">
                            ...
                            <h4 class="text-section">Secretaria</h4>
                        </li>
                        <li class="nav-item">
                ...
                <div class="page-inner">
                    <div
                        ...
                        <div class="ms-md-auto py-2 py-md-0">
                            <a href="#" class="btn btn-primary btn-round">Adicionar Visitante</a>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                ...
                                                <h4 class="card-title"><?php echo getTurmas(); ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-round">
                                <div class="card-body pb-0">
                                    <div class="h1 fw-bold float-end" id="rate"><?= getvisitrate() ?>%</div>
